...
//        LinkedList<String> end = null;
        LinkedList<String> end = start.stream()
                .distinct()
...
//        Map<String, Integer> end = null;
        Map<String, Integer> end = start.stream()
...
//        List<Integer> end = null;
        List<String> end = start.stream()
                .filter(i -> i % 2 == 0)
                .map(this::repeatBySoManyNumbers)
                .collect(Collectors.toList());
...
//        long count = -1L;
        long count = nullGeneratingStream
