...
//        Optional<Integer> hasWholeRoot = null;
        Optional<Integer> hasWholeRoot = start.stream()
                .peek(System.out::println)
                .filter(LevelTwo::hasWholeRoot)
                .findFirst();
...
//        Optional<String> end = null;
        Optional<String> end = start.stream()
                .filter(i -> i % 2 == 0)
                .findFirst()
                .map(String::valueOf);
